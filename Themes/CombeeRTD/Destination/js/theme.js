$( document ).ready(function() {
    ...
    // Add subcurrent class to clicked h2 menu link
    $(document).on('click', ".menu-vertical .current ul li", function() {
      $(".menu-vertical .current .subcurrent").removeClass("subcurrent");
